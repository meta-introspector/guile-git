...
pkgdatadir = $(datadir)/guile-git
pkgincludedir = $(includedir)/guile-git
pkglibdir = $(libdir)/guile-git
pkglibexecdir = $(libexecdir)/guile-git
...
CONFIG_CLEAN_FILES = git/configuration.scm tests/ssh.scm pre-inst-env
...
INFO_DEPS = $(srcdir)/doc/guile-git.info
TEXINFO_TEX = $(top_srcdir)/build-aux/texinfo.tex
am__TEXINFO_TEX_DIR = $(top_srcdir)/build-aux
DVIS = doc/guile-git.dvi
PDFS = doc/guile-git.pdf
PSS = doc/guile-git.ps
HTMLS = doc/guile-git.html
TEXINFOS = doc/guile-git.texi
TEXI2DVI = texi2dvi
...
am__DIST_COMMON = $(doc_guile_git_TEXINFOS) $(srcdir)/Makefile.in \
	$(srcdir)/guile.am $(srcdir)/pre-inst-env.in \
	$(top_srcdir)/build-aux/compile \
	$(top_srcdir)/build-aux/install-sh \
	$(top_srcdir)/build-aux/mdate-sh \
	$(top_srcdir)/build-aux/missing \
	$(top_srcdir)/build-aux/texinfo.tex $(top_srcdir)/doc/local.mk \
	$(top_srcdir)/git/configuration.scm.in \
	$(top_srcdir)/tests/ssh.scm.in COPYING COPYING.LESSER INSTALL \
	NEWS build-aux/compile build-aux/install-sh build-aux/mdate-sh \
...
ACLOCAL = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/missing automake-1.16
AWK = gawk
CC = gcc
...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Guile-Git\" -DPACKAGE_TARNAME=\"guile-git\" -DPACKAGE_VERSION=\"0.6.0\" -DPACKAGE_STRING=\"Guile-Git\ 0.6.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"https://gitlab.com/guile-git/guile-git/\" -DPACKAGE=\"guile-git\" -DVERSION=\"0.6.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EXEEXT = 
GIT_UPLOAD_PACK = /usr/bin/git-upload-pack
GUILD = /mnt/data1/nix/root/bin/guild
GUILE = /mnt/data1/nix/root/bin/guile
GUILE_CONFIG = /mnt/data1/nix/root/bin/guile-config
GUILE_EFFECTIVE_VERSION = 3.0
GUILE_TARGET = 
GUILE_TOOLS = /mnt/data1/nix/root/bin/guild
...
LDFLAGS = 
LIBGIT2_CFLAGS = -I/usr/local/include
LIBGIT2_LIBDIR = /usr/local/lib
LIBGIT2_LIBS = -L/usr/local/lib -lgit2
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = guile-git
PACKAGE_BUGREPORT = 
PACKAGE_NAME = Guile-Git
PACKAGE_STRING = Guile-Git 0.6.0
PACKAGE_TARNAME = guile-git
PACKAGE_URL = https://gitlab.com/guile-git/guile-git/
PACKAGE_VERSION = 0.6.0
PATH_SEPARATOR = :
PKG_CONFIG = /usr/bin/pkg-config
PKG_CONFIG_LIBDIR = /mnt/data1/nix/root//lib:/usr/local//lib:/usr/lib/x86_64-linux-gnu/pkgconfig/
PKG_CONFIG_PATH = /mnt/data1/nix/root/lib/pkgconfig:/mnt/data1/nix/root/lib64/pkgconfig/:/usr/local/lib/pkgconfig:/usr/local/lib64/pkgconfig/:/usr/lib/x86_64-linux-gnu/pkgconfig/
SET_MAKE = 
SHELL = /bin/bash
SSHD = /usr/sbin/sshd
...
STRIP = 
VERSION = 0.6.0
abs_builddir = /mnt/data1/nix/time/2024/03/13/guile-git
abs_srcdir = /mnt/data1/nix/time/2024/03/13/guile-git
abs_top_builddir = /mnt/data1/nix/time/2024/03/13/guile-git
abs_top_srcdir = /mnt/data1/nix/time/2024/03/13/guile-git
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mnt/data1/nix/time/2024/03/13/guile-git/build-aux/install-sh
...
CLEANFILES = $(GOBJECTS)
EXTRA_DIST = $(SOURCES) $(NOCOMP_SOURCES) README.md pre-inst-env.in \
	build-aux/test-driver.scm build-aux/check-libgit2-abi.scm \
	guix.scm .guix/modules/guile-git-package.scm static/bg.png \
	static/main.css static/README $(TESTS) $(TESTS_UTILS)
GUILE_WARNINGS = \
...
.SUFFIXES:
.SUFFIXES: .scm .go .dvi .log .ps .scm$(EXEEXT) .trs
am--refresh: Makefile
	@:
...
$(am__aclocal_m4_deps):
git/configuration.scm: $(top_builddir)/config.status $(top_srcdir)/git/configuration.scm.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
tests/ssh.scm: $(top_builddir)/config.status $(top_srcdir)/tests/ssh.scm.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
$(srcdir)/doc/guile-git.info: doc/guile-git.texi $(srcdir)/doc/version.texi $(doc_guile_git_TEXINFOS)
...
doc/guile-git.dvi: doc/guile-git.texi $(srcdir)/doc/version.texi $(doc_guile_git_TEXINFOS) doc/$(am__dirstamp)
	$(AM_V_TEXI2DVI)TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc' \
	$(TEXI2DVI) $(AM_V_texinfo) --build-dir=$(@:.dvi=.t2d) -o $@ $(AM_V_texidevnull) \
	`test -f 'doc/guile-git.texi' || echo '$(srcdir)/'`doc/guile-git.texi

doc/guile-git.pdf: doc/guile-git.texi $(srcdir)/doc/version.texi $(doc_guile_git_TEXINFOS) doc/$(am__dirstamp)
	$(AM_V_TEXI2PDF)TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc' \
	$(TEXI2PDF) $(AM_V_texinfo) --build-dir=$(@:.pdf=.t2p) -o $@ $(AM_V_texidevnull) \
	`test -f 'doc/guile-git.texi' || echo '$(srcdir)/'`doc/guile-git.texi

doc/guile-git.html: doc/guile-git.texi $(srcdir)/doc/version.texi $(doc_guile_git_TEXINFOS) doc/$(am__dirstamp)
	$(AM_V_MAKEINFO)rm -rf $(@:.html=.htp)
	$(AM_V_at)if $(MAKEINFOHTML) $(AM_MAKEINFOHTMLFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc \
	 -o $(@:.html=.htp) `test -f 'doc/guile-git.texi' || echo '$(srcdir)/'`doc/guile-git.texi; \
	then \
	  rm -rf $@ && mv $(@:.html=.htp) $@; \
	else \
...
$(srcdir)/doc/stamp-vti: doc/guile-git.texi $(top_srcdir)/configure
	@test -f doc/$(am__dirstamp) || $(MAKE) $(AM_MAKEFLAGS) doc/$(am__dirstamp)
	@(dir=.; test -f ./doc/guile-git.texi || dir=$(srcdir); \
	set `$(SHELL) $(top_srcdir)/build-aux/mdate-sh $$dir/doc/guile-git.texi`; \
...
mostlyclean-aminfo:
	-rm -rf doc/guile-git.t2d doc/guile-git.t2p

clean-aminfo:
	-test -z "doc/guile-git.dvi doc/guile-git.pdf doc/guile-git.ps \
	  doc/guile-git.html" \
	|| rm -rf doc/guile-git.dvi doc/guile-git.pdf doc/guile-git.ps \
	  doc/guile-git.html
...
installdirs:
	for dir in "$(DESTDIR)$(infodir)" "$(DESTDIR)$(godir)" "$(DESTDIR)$(moddir)"; do \
